...
import 'package:rime_app/widgets/common/rich_text.dart';
...
class TrackerTimelineItem extends StatelessWidget {
  const TrackerTimelineItem({Key? key, required this.node}) : super(key: key);
  ...
  Widget richTextWidget(String data) {
    try {
      List<RichTextNext> listData = (jsonDecode(data) as List<dynamic>)
          .map((e) => RichTextNext.fromJson(e))
          .toList();

      return RichTextWidget(
        richTextModels: listData,
