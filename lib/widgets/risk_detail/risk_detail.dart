...
class _RiskDetailState extends State<RiskDetail> {
  ...
  Widget build(BuildContext context) {
    return WebviewPage(
        url:
            '$WEB_ENDPOINT/mobile/risk-detail?title=${Uri.encodeComponent(widget.title)}&entityName=${Uri.encodeComponent(widget.entityName)}&data=${Uri.encodeComponent(widget.data)}');
  }
}
