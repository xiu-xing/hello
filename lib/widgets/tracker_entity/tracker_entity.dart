      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            CommonTabBar(
              tabs: [
                "项目企业 ${_enterpriseCount ?? ""}",
                " 投资机构 ${_institutionCount ?? ""}",
                " 行业赛道 ${_verticalCount ?? ""}"
              ],
              onTap: (index) {
