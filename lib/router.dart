...
import 'package:rime_app/widgets/authorization/sign_in.dart';
...
void defineRoutes(FluroRouter router) {
  ...
  /// home
  router.define(Routes.home, handler: Handler(handlerFunc: (context, params) {
    return Skeleton();
  ...
  /// webview
  router.define(Routes.webview, handler:
  ...
  /// qksh
  router.define(Routes.quickSearch, handler:
      Handler(handlerFunc: (context, Map<String, List<String>> params) {
  ...
  router.define(Routes.signIn, handler: Handler(handlerFunc: (context, params) {
    return SignIn();
  }), transitionType: TransitionType.cupertino);
  ...
  router.define(
    ...
    handler: Handler(handlerFunc: (context, Map<String, List<String>> params) {
      ...
      if (title != null && entityName != null && data != null)
        return RiskDetail(title: title, entityName: entityName, data: data);
    }),
    transitionType: TransitionType.cupertino,
  );
