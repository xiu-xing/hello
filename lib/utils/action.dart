  ...
  static void navigatorByAction(
    ...
    switch (tapAction.type) {
      ...
      case ACTION_TYPE_SUB_PROFILE:
        ...
        break;
      case ACTION_TYPE_POP_UP:
        String? t = title;
        String? e = entityName;
        String? d = tapAction.data?["value"];
        if (t != null && e != null && d != null) {
          router.navigateTo(
            context,
            '${Routes.riskDetailWebview}?title=${Uri.encodeComponent(t)}&entityName=${Uri.encodeComponent(e)}&data=${Uri.encodeComponent(d)}',
          );
        }
        break;
    }
